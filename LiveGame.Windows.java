...
public class Window implements Runnable {
    ...
    void initFrame() {
        frame = new JFrame();
        frame.getContentPane().setLayout(null); // расположение по центру
        frame.setSize(Config.SIZE * Config.WIDTH + 25, Config.SIZE * Config.HEIGHT + 45);    // размер игрового поля
       // frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // закрытие при нажатие на крестик
        frame.setLocationRelativeTo(null); // расположение  окно по центру экрана
